window.onload = function(){
    ...
    medium.onmousemove = function(e){
        ...
        var markOffsetHeight = mark.offsetHeight;
        var mediumOffsetHeight = this.offsetHeight;
        //判断放大镜遮罩层溢出
        if(left<0){
            left = 0;
        ...
        if(top<0){
            top = 0;
        }else if(top > mediumOffsetHeight - markOffsetHeight){
            top = mediumOffsetHeight - markOffsetHeight;
        }
        ...
        tmpNodes[j].onmouseover = function(){
            ...
            for(var k=0;k<liNum;k++){
                if(k != _this.index){
                    ...
                    imgI.style.border = "1px solid #cccccc";
